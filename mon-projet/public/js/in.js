// ==================== CONFIG ====================
const API_BASE = "https://82eb4775c9ed.ngrok-free.app";
...
async function loadDesh() {
  try {
    ...
    console.error("Erreur loadDesh:", err);
  }
}
...
async function loadVentesJour() {
  try {
    ...
    console.error("Erreur loadVentesJour:", err);
  }
}
...
async function loadVentesMois() {
  try {
    ...
    console.error("Erreur loadVentesMois:", err);
  }
}
...
async function loadBenefDep() {
  try {
    ...
    console.error("Erreur loadBenefDep:", err);
  }
}
